...
function getPlanItemInput(formData: FormData) {
  return {
    ...
    objective: parseOptionalString(formData.get("objective")),
    targetAudience: parseOptionalString(formData.get("targetAudience")),
    keyMessage: parseOptionalString(formData.get("keyMessage")),
    callToAction: parseOptionalString(formData.get("callToAction")),
